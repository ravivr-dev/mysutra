...
const String appFontRoboto = 'Roboto';
...
class RobotoComponentFonts extends AiloitteFonts {
  RobotoComponentFonts()
      : super(
  ...
  static String? defaultFontType = appFontRoboto;
  ...
  TextStyle mediumStyle({
    ...
    return customStyle(
      ...
      backgroundColor: backgroundColor,
      decoration: decoration,
      fontType: fontType ?? appFontRoboto,
      height: height,
      letterSpacing: letterSpacing,
      wordSpacing: wordSpacing,
      foreground: foreground,
