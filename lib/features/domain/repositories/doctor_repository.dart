...
abstract class DoctorRepository {
  ...
  Future<Either<Failure, WithdrawalEntity>> getWithdrawals(GetPayoutParams params);

  Future<Either<Failure, List<BookingEntity>>> getBookings(GetPayoutParams params);
}
