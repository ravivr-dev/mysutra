...
class _UserRestClient implements UserRestClient {
  ...
  @override
  Future<ProfileUpdateModel> updateProfile(Map<String, dynamic> map) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    _data.addAll(map);
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<ProfileUpdateModel>(Options(
      method: 'PUT',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ProfileUpdateModel.fromJson(_result.data!);
    return value;
  }
  ...
  @override
  Future<ResponseModel> getFollowings(Map<String, dynamic> map) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  Future<VideoRoomResponseModel> getVideoRoomId(
    ...
    _data.addAll(map);
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<VideoRoomResponseModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<HttpResponse<List<int>>> downloadPdf(String url) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
