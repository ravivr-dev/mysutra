class AppRoutes {
  ...
  static const String withdrawBalanceRoute = '/withdraw_balance_screen';
  static const String selectBankAccountRoute = '/select_bank_account_screen';
  static const String waitingRoute = '/waiting_screen';
